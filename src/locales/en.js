export default {
  ...
  // Внутренние слова (HOUSE, HEXARCH, TEMPER, DOCTRINE) во внешний текст не
  // идут — правило проекта.
  // ⚠️ ASCENSION ИЗ ЭТОГО СПИСКА ВЫВЕДЕНО (решение владельца 25.09.2026):
  //    обряд игрок видит и называет этим словом. Снято для него ОДНОГО —
  //    остальные четыре остаются внутренними.
  landing: {
    hero: {
