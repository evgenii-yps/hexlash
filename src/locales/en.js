export default {
  ...
  marketing: {
    ...
    hero: {
      title: "BIGGER FIGHTS INCOMING",
      play: "PLAY",
    },
    gameplay: {
      kicker: "SECTION 02",
      heading: "GAMEPLAY",
      subtitle: "Turn-based combat on a hex arena. Positioning matters. Every move is a choice — and every choice closes another door.",
      recTag: "REC · INCOMING",
      videoLabel: "VIDEO INCOMING",
      caption: "First match recordings drop with the next release.",
    },
    token: {
      kicker: "SECTION 03",
      headingPart1: "$HEX — ",
      headingAccent: "Utility token",
      headingPart2: " on Base.",
      para1: "$HEX is the utility token of the Hexlash economy. Earn it through ranked play, spend it on fighter upgrades.",
      para2: "The game stays fully playable without the token. No pay-to-win. $HEX is the receipt of skill, not the price of it.",
      learnMore: "LEARN MORE →",
    },
    roadmap: {
      kicker: "SECTION 04",
      heading: "ROADMAP",
      subtitle: "From combat to economy.",
      phase1Name: "CORE COMBAT",
      phase1Status: "DONE",
      phase2Name: "FOUR ARCHETYPES",
      phase2Status: "IN PROGRESS",
      phase3Name: "BELTS & CAPTAINS",
      phase3Status: "NEXT",
      phase4Name: "$HEX LIVE",
      phase4Status: "LATER",
    },
    subscribe: {
      ...
      subtitle: "Patch notes, tournament invites, $HEX drops.",
    ...
    footer: {
      tagline: "Turn-based fighting on Base.",
      colGame: "GAME",
      colToken: "TOKEN",
      colSupport: "SUPPORT",
      linkPlay: "Play",
      linkGameplay: "Gameplay",
      linkToken: "$HEX",
      linkHelp: "Help",
      linkPrivacy: "Privacy",
      linkTerms: "Terms",
      copyright: "© Hexlash. All rights reserved.",
    },
  },
};
