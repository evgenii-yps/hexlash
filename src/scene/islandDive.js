...
// читается как промах.
// Экспортируется, потому что этой кривой едет не только пролёт: подлёт камеры
// в новом пространстве (gateApproach.js) — обратная половина той же поездки, и
// вторая копия кривой означала бы, что две половины одного движения можно
// нечаянно развести. Числа поездки живут в DIVE выше, кривая — здесь.
