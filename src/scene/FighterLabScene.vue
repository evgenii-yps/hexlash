...
const techniqueMoves = [
  ...
  { id: 'hook',      label: 'ХУК',        kind: 'clip',    run: (f) => f.hook(),      limb: 'armR' },
  { id: 'uppercut',  label: 'АППЕРКОТ',   kind: 'clip',    run: (f) => f.uppercut(),  limb: 'armL' },
  { id: 'bodyShot',  label: 'ПО КОРПУСУ', kind: 'clip',    run: (f) => f.bodyShot(),  limb: 'armL' },
