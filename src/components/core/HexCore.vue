...
const props = defineProps({
  ...
  /* Медленное заполнение граней. Включено ВЕЗДЕ, розовые разделы и вход в том
     числе (решение владельца 22.09.2026). Выключатель оставлен ради страницы
     разбора /dev/core — она единственная им и пользуется; в живых экранах его
     ставить не надо, яркость раздела задаёт режим, а не наличие света. */
