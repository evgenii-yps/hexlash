<!-- /play/arena — 3D-арена. Сама сцена (ArenaScene) — защищённый файл: в ней
     живут бой и моторика. Всё, что НЕ бой, стоит здесь, поверх неё:

       FightResultPanel — итог обычного боя (VICTORY / DEFEAT). В забеге и на
