...
/* ⚠️ СТРОКА ШАГА ПОД ПОДПИСЬЮ КНОПКИ — НА ВСЕХ НИЗКИХ ЛЕЖАЧИХ КАДРАХ.
   ...
   Болезнь этого правила: строка стоит от НИЖНЕЙ кромки окна (88 px), а подпись
   FIGHT привязана к кнопке В СЦЕНЕ и ездит вместе с камерой. Пока они
   расходились, всё сходилось само; когда камера поднялась под стоящих бойцов,
   подпись уехала вниз и легла ровно на строку. Замерено: перекрытие 11 px на
   всей полосе примерно от 460 до 590 по высоте.

   Наверх строку уводить нельзя — там теперь головы бойцов (на 844×390 строка
   стояла 120…131 против макушек со 113), а при выбранном размере состава
   верхнюю полосу занимает ещё и переключатель.

   600, а не 590: перелом — не место для впритык. Выше 600 кадр уже достаточно
   высок, чтобы 88 px снизу гарантированно оставались ниже подписи, и там
