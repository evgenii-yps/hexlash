...
@media (max-height: 460px) and (orientation: landscape) {
  /* ⚠️ СТРОКА ШАГА ВЕРНУЛАСЬ ВНИЗ — НО НИЖЕ ПОДПИСИ КНОПКИ, а не выше её.
     Наверх её увели тогда, когда на плитах было плоско: снизу она ложилась на
     подпись FIGHT. С 17.09.2026 на плитах стоят бойцы, и верхняя полоса — это
     их головы: замерено на 844×390, строка 120…131 против макушек со 113.
     Полосы, свободной сверху, там больше нет — при выбранном размере состава
     её занимает переключатель (76…107).
     Снизу полоса есть и она с запасом: подпись FIGHT кончается на 334 из 390
     (худший кадр из проверенных — 1024×420, 378 из 420), а строка высотой
     11 px встаёт под самый край. */
