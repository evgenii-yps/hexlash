...
export const COMBAT_BALANCE = {
  ...
  openField: {
    ...
    edgeMargin: 2.2,
    // ПОДАЛЬШЕ ЛИ КАМЕРА, ЧЕМ В БОЮ ОДИН НА ОДИН. Коридор удаления камеры на
    // большом поле: она следит за стороной игрока, а не за всем полем, поэтому
    // числа близки к обычным. Верхняя граница больше обычной (18) ровно настолько,
    // чтобы четвёрка QUAD целиком влезала в кадр.
    camMinDistance: 6,
    camMaxDistance: 22,
