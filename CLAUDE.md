...
/src
  ...
  composables/             — Reusable composables. `useDocumentMeta.js` (added 8b C1) — manual SEO meta tag manipulation (title, meta description, og:*, twitter:*) with restore-on-unmount. (`useScrollFadeIn.js` added 8c C1, removed during auth/landing-redesign cleanup — orphaned after MarketingView replacement PR #408, 0 references confirmed.)
