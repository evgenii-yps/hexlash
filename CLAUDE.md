...
⚠️ **Охранное поле в источниках расходится:** Документ А 0.3 говорит «не менее
половины ширины знака», README эталона — «не меньше четверти высоты». Расхождение
не разрешено, арбитр — владелец.
...
**Правила размещения связки «знак + слово» в системе нет — сознательно** (решение
владельца 05.09.2026). Где ставится связка, а где только знак, решается по месту.
Измеренное ограничение: слово читается уверенно от 70 точек высоты, читается на
48, на 32 буквы слипаются.
