...
Панель игры 40px (32px на телефоне) · экран загрузки, обе половины · шапка и
подвал лендинга · вход · сброс пароля · 404 — плюс иконки вкладки и приложения и
...
- ⚠️ **Лесенка собрана из двух разных форм.** Опись 05.09.2026 нашла три формы
  ...
  росчерков и стоят в одном списке размеров. Панель игры (бокс 40) и подвал
  лендинга (бокс 44) показывают **разный знак** на обычном и на плотном экране.
