...
подвальная пара целиком. И ⚠️ код пока расходится: слово подвала стоит
насыщенностью 800 и разрядкой `.16em`, семейство не объявлено. Пропорции при этом
совпадают. Приведение типографики — отдельная задача.
